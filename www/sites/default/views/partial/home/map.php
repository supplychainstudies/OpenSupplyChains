...
<?php if(isset($supplychain) && $supplychain): ?>
        ...
        <div class="map-description">
            <a href="view/<?php $supplychain->id ?>">
                <h2 class="map-title"><?php isset($supplychain->attributes->title) ? HTML::chars($supplychain->attributes->title) : "An Unnamed Sourcemap" ?></h2>
            </a>
        ...
        <div class="map-controls">
            ...
            <div class="map-controls-publish">
                <input id="map-publish-checkbox" type="checkbox" name="publish" onclick="window.location='edit/visibility/<?php $supplychain->id ?>?publish=<?php $public ? "no" : "yes"?>'; return true;"<?php $public ? "checked" : "" ?>/>
                <a id="map-publish-link">Public</a>
            </div>
            <div class="map-controls-edit">
                <a href="edit/<?php $supplychain->id ?>">Edit</a>
            </div>
            <div class="map-controls-delete">
                <a class="red" href="delete/<?php $supplychain->id ?>">Delete</a>
            </div>
        </div>
        <div class="clear"></div>
<?php endif; ?>
