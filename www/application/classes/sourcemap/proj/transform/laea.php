<?php
class Sourcemap_Proj_Transform_Laea extends Sourcemap_Proj_Transform {
/*******************************************************************************
...
*******************************************************************************/
    ...
    public $P00 = .33333333333333333333;
    public $P01 = .17222222222222222222;
    public $P02 = .10257936507936507936;
    public $P10 = .06388888888888888888;
    public $P11 = .06640211640211640211;
    public $P20 = .01641501294219154443;
    ...
    public function init() {
        ...
        } else if(abs(t) < Sourcemap_Proj::EPSLN) {
        ...
        if($this->es > 0) {
            ...
            $this->qp = Sourcemap_Proj::qsfnz($this->e, 1.0);
            $this->mmf = .5 / (1.0 - $this->es);
            ...
            switch ($this->mode) {
                ...
                case $this->OBLIQ:
                    ...
                    $this->sinb1 = Sourcemap_Proj::qsfnz($this->e, sinphi) / $this->qp;
                    $this->cosb1 = sqrt(1.0 - $this->sinb1 * $this->sinb1);
    ...
    public function inverse($p) {
        ...
        if($this->sphere) {
            ...
            switch ($this->mode) {
                case $this->EQUIT:
                    $phi = (abs($rh) <= Sourcemap_Proj::EPSLN) ? 0. : asin($y * $sinz / $rh);
                    $x *= $sinz;
                    $y = $cosz * $rh;
                    break;
                case $this->OBLIQ:
