...
Route::set('admin/collection/id/action', 'admin/<controller>(/<id>(/<action>))', array(
        'id' => '\d+', 
        'action' => 'delete_role|add_role|add_member|delete_member|delete_alias|change_perms|delete_user|delete_supplychain|delete_group|delete_role_entry|change_usergroup_perms'))
    ->defaults(array(
        'directory' => 'admin', 
        'controller' => 'users', 
        'action' => 'details'
