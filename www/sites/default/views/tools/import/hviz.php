...
<div class="container">
    <form class="sourcemap-form" name="hviz-import" method="post" enctype="multipart/form-data">
    <label for="supplychain_name">Name:</label><br />
    <input name="supplychain_name" type="text" value="A Sourcemap" />

    <label for="hviz_file">File:</label><br /><br/>
    <input type="file" name="hviz_file" /><br />
