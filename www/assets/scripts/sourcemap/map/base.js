...
// Jquery shake $.shake
jQuery.fn.shake = function ( ) { this.each(function(init) { var jqNode = $(this); for (var x = 1; x <= 2; x++) { jqNode.animate({ 'left' : '-=15px' },15) .animate({ 'left' : '+=15px' },15) .animate({ 'left' : '+=15px' },15) .animate({ 'left' : '-=15px' },15); } }); return this; }
