<?php
class Sourcemap_Proj_Transform_Nzmg extends Sourcemap_Proj_Transform {
/*******************************************************************************
...
*/
  ...
  */
    public function forward($p) {
        ...
        $d_phi = $delta_lat / Sourcemap_Proj::SEC_TO_RAD * 1E-5;       
        $d_lambda = $delta_lon;
        $d_phi_n = 1;  // d_phi^0
  ...
  */
    public function inverse($p) {
        ...
        $lat = $this->lat0 + ($d_phi * Sourcemap_Proj::SEC_TO_RAD * 1E5);
