...
<h4>Sourcemap.ORG User ID: <?php HTML::chars($old_user_id) ?></h4>
<?php Form::input('old_user_id', $old_user_id, array('type' => 'hidden')) ?>
<h4>Sourcemap.COM User ID: <?php HTML::chars($new_user_id) ?> (<?php HTML::chars(ORM::factory('user', $new_user_id)->username) ?>)</h4>
<?php Form::input('new_user_id', $new_user_id, array('type' => 'hidden')) ?>
