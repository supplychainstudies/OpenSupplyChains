<?php
class Sourcemap_Proj_Transform_Poly extends Sourcemap_Proj_Transform {
...
*******************************************************************************/
    ...
    public function init() {
        ...
        $this->ml0 = Sourcemap_Proj::mlfn($this->e0, $this->e1, $this->e2, $this->e3, $this->lat0);//si que des zeros le calcul ne se fait pas
